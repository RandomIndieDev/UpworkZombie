...
namespace Lean.Common
{
	...
	public class LeanPlane : MonoBehaviour
	{
		...
		public float GetDistance(Vector3 position)
		{
			...
			return Vector3.Distance(transform.TransformPoint(point) + transform.forward, position) ;
		}
		...
		private static float RayToPlaneDis(Vector3 point, Vector3 normal, Ray ray, ref float distance)
		{
